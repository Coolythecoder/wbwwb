...
std::string MakeVkErrorMessage(VkResult result, const char* operation) {
    std::string message = "Vulkan call failed";
...
void CheckVk(VkResult result, const char* operation) {
    if (result != VK_SUCCESS) {
        throw std::runtime_error(MakeVkErrorMessage(result, operation));
    }
}
